...
/*
 * main
 * Purpose: initializes the myRIO session, calls user-defined double_in function
 * Information transfer: sends lcd display prompt to double_in, receives user input from double_in
 * 		(main -> double_in -> main)
 */
    ...
    /* begin lcd output and user input */
    test_1 = double_in(prompt);		// first lcd display and keypad input
    printf("%lf \n", test_1);

    test_2 = double_in(prompt);		// second lcd display and keypad input
    printf("%lf \n", test_2);
 ...
 * Information transfer: recieves prompts from 'main, sends prompts and outputs to 'printf_lcd' and
